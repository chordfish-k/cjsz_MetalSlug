...
public class Enemy extends ElementObj {
    private String fx = "up";//̹��Ĭ�ϳ���
    private int moveSpeed = 2;    //̹������
    private int hp = 1; //̹��Ѫ��
    private int bulletNum = 1;//̹���ӵ���
    private int bulletTime = 100; //̹�˷����ӵ����
    ...
    public void move() {
        ...
        if (this.right && this.getX() < GameJFrame.getGameX() - 20 - this.getW()) {  //�������ת�ɴ�������
            this.setX(this.getX() + moveSpeed);
            move = true;
        }
